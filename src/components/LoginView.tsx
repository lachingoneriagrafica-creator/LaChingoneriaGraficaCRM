...
export const LoginView: React.FC = () => {
  const { loginWithEmailPassword, loading, authErrorMessage, clearAuthError } = useAuth();
      ...
      <div className="w-full max-w-md z-10 flex flex-col items-center">
        ...
        <div className="w-full bg-[#1f1b16] border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-[11px] font-mono text-[#a58a8e] bg-[#2a2723] px-2.5 py-1 rounded-md border border-white/5">
              Portal Seguro
            </span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full mt-3 bg-[#8d153e] hover:bg-[#a61c4b] active:bg-[#721031] text-white font-headline text-sm font-semibold py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 shadow-lg transition-all cursor-pointer hover:scale-[1.01] active:scale-98 disabled:opacity-50 border border-[#ffb1bf]/20"
            >
              {isSubmitting ? (
          ...
          <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-center gap-2 text-[11px] text-[#a58a8e]">
